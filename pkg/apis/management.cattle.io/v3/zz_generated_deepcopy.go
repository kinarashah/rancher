...
func (in *AgentDeploymentCustomization) DeepCopyInto(out *AgentDeploymentCustomization) {
	*out = *in
	...
	if in.OverrideAffinities != nil {
		in, out := &in.OverrideAffinities, &out.OverrideAffinities
		*out = make([]corev1.Affinity, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	in.ContainerResourceRequirements.DeepCopyInto(&out.ContainerResourceRequirements)
	return
}
...
func (in *ClusterSpecBase) DeepCopyInto(out *ClusterSpecBase) {
	*out = *in
	...
	if in.AgentDeploymentCustomization != nil {
		in, out := &in.AgentDeploymentCustomization, &out.AgentDeploymentCustomization
		*out = new(AgentDeploymentCustomization)
		(*in).DeepCopyInto(*out)
	}
	return
