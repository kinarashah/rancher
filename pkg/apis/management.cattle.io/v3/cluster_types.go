...
const (
	...
	// ClusterConditionControlPlaneReady RKE control plane finished reconciling (for v2prov clusters)
	ClusterConditionControlPlaneReady condition.Cond = "ControlPlaneReady"
