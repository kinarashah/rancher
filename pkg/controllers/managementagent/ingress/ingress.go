...
func (c *Controller) sync(key string, obj ingresswrapper.Ingress) (runtime.Object, error) {
...
func generateExpectedServices(state map[string]string, ingress ingresswrapper.Ingress) (map[string]ingressService, error) {
	var err error
...
func getIngressRelatedServices(serviceLister v1.ServiceLister, obj ingresswrapper.Ingress, expectedServices map[string]ingressService) (map[string]*corev1.Service, error) {
...
func updateOrDelete(obj ingresswrapper.Ingress, service *corev1.Service, expectedServices map[string]ingressService, isNeedNodePort bool) (bool, *corev1.Service, error) {
	shouldDelete := false
